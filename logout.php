...
<div class="container">
    <div id="login-box">
        <div class="logo">
            <img src="http://img.mp.itc.cn/upload/20170811/8769397e15b74c7a93ab264e866b4a35_th.jpg"
                 class="img img-responsive img-circle center-block">
            <h1 class="logo-caption"><span class="tweak">畢業旅行</span>投票</h1>
        </div><!-- /.logo -->
        <div class="controls" style="color: whitesmoke">
