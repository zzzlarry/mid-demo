...
<body>
    <div class="container">
        <div id="login-box">
            <div class="logo">
                <img src="http://imgapi.nownews.com/?w=640&q=60&src=http%3A%2F%2Fs.nownews.com%2F26%2F2c%2F262c9401167dcdee8c78097e0ed05da7.jpg"
                     class="img img-responsive img-circle center-block">
                <h1 class="logo-caption"><span class="tweak">畢業旅行</span>投票確認</h1>
            </div><!-- /.logo -->
            <div class="controls">
                <form action="save2.php" method="post">
                    <?php
                    print "
<table border='1' width='100%' id='table1' style='color: white'>
    <tr>
